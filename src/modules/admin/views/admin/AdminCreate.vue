            ...
            <form class="row g-3" @submit.prevent="handleSubmit">
              <div class="col-md-6">
                ...
                <input type="text" class="form-control" :class="{ 'is-invalid': errors.name }" name="name"
                  v-model="formCreate.name" placeholder="Enter name...">
              ...
              <div class="col-md-6">
                ...
                <input type="email" class="form-control" :class="{ 'is-invalid': errors.email }" name="email"
                  v-model="formCreate.email" placeholder="Enter email...">
                <div v-if="errors.email" class="invalid-feedback">{{ errors.email[0] }}</div>
              </div>

              <div class="col-md-6">
                <label class="form-label d-flex">Phone</label>
                <input type="text" class="form-control" :class="{ 'is-invalid': errors.phone }" inputmode="numeric"
                  name="phone" v-model="formCreate.phone" placeholder="Enter phone number...">
              ...
              <div class="col-md-6">
                ...
                <input type="password" class="form-control" :class="{ 'is-invalid': errors.password }"
                  v-model="formCreate.password" placeholder="Enter password...">
              ...
              <div class="col-md-6">
                ...
                <input type="password" class="form-control" :class="{ 'is-invalid': errors.password_confirmation }"
                  v-model="formCreate.password_confirmation" placeholder="Confirm password...">
                <div v-if="errors.password_confirmation" class="invalid-feedback">{{ errors.password_confirmation[0] }}
                </div>
              </div>
